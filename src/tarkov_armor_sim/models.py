...
class CalculationConfidence(StrEnum):
    VERIFIED = "已验证"
    APPROXIMATION = "社区近似"
    EXPERIMENTAL = "实验性"
...
class Ammo:
    ...
    source_version: str = "eft-1.0.6.0-snapshot-2026-07-30"
    aliases: tuple[str, ...] = ()
